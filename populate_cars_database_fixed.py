...
# -*- coding: utf-8 -*-
"""
مدير قاعدة بيانات السيارات الشامل - النسخة المصححة
    ...
    with app.app_context():
        ...
        for i, car_data in enumerate(cars_data, 1):
            try:
                ...
                if image_filename:
                    car_data['image_url'] = f"/static/images/cars/{image_filename}"
                else:
                    # استخدام صورة افتراضية إذا فشل التحميل
                    car_data['image_url'] = "/static/images/cars/default-car.jpg"
